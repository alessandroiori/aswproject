...
set CLASSPATH=%APP_HOME%\lib\client.jar;%APP_HOME%\lib\service.jar;%APP_HOME%\lib\asw-util.jar

@rem Execute client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CLIENT_OPTS%  -classpath "%CLASSPATH%" asw.intro.client.Main %CMD_LINE_ARGS%
