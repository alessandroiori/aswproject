...
set CLASSPATH=%APP_HOME%\lib\server.jar;%APP_HOME%\lib\service.jar;%APP_HOME%\lib\asw-util.jar

@rem Execute server
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SERVER_OPTS%  -classpath "%CLASSPATH%" asw.intro.server.Server %CMD_LINE_ARGS%
